  ...
  <div class="card w-full max-w-md rounded-2xl p-6 sm:p-8 bg-white">
    ...
    <div id="auth-form">
      ...
      <button onclick="handleGoogleLogin()"
              class="w-full btn border-2 border-gray-300 hover:border-gray-400 bg-white text-gray-700 font-medium mb-4 py-3 flex items-center justify-center gap-2 rounded-lg transition-colors">
